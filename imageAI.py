...
#Make Image
def generate_images(group_data, strain, experiment_title):
            ...
            draw.text((20, 475 - 50), f"Number of Subjects: {mice_info}", fill='black', font=fontW)
            ...
            for index, group in enumerate(group_data):
                ...
                arrow_length = duration_to_arrow_length(25)
            ...
            for group in group_data:
                ...
                draw.text((u, y + 38), gender, fill='black', font=fontW)
                draw.text((u, y + 20), beam, fill='black', font=fontW)
